...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-CosmicGuerilla_MiSTer.git"
CORE_NAME=(Arcade-CosmicGuerilla)
...
UPSTREAM_CORE_NAME=(Arcade-CosmicGuerilla)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-CosmicGuerilla.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-CosmicGuerilla.rbf)
